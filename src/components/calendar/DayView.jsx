...
const DayView = ({ date, scheduledEvents, onPrevDay, onNextDay }) => {
    ...
    const getEventsForSlot = (hour) => {
        ...
        return events.filter(event => {
            // ⭐ Mantenemos la corrección de seguridad: Validar ambas horas
            ...
            // ⭐ CORRECCIÓN CLAVE: Muestra el evento si empieza en esta hora O si ya ha empezado y aún no ha terminado.
